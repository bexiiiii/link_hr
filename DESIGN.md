...
**Identity:** предоставленный фирменный знак `assets/brand/link-mark.png`: тёмный скруглённый квадрат с радужной цепочкой. Он появляется только при входе, загрузке и в фирменных пустых состояниях. Остальной продукт остаётся светлым и строгим.
