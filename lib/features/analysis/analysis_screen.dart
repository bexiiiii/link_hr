                            ...
                            Transform.translate(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      (s.company.isEmpty ? 'Link' : s.company)
                                          .toUpperCase(),
                ...
                children: [
                  ...
                  if (_error != null)
                    ...
                    const EmptyState(
                      ...
                      message:
                          'Анализ появится, когда у сотрудников будут учётные записи.',
                    )
                  else
...
class _EntryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final badge = entry.score >= 80
        ? AppColors.greenDeep
        : (entry.score >= 60 ? AppColors.amber : AppColors.red);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
        ...
        _Scale(
          code: 'SIP-B',
          topic: 'За невыполнение чеклистов и задач',
          degree: entry.taskDegree,
        ),
        _Scale(
          code: 'SIP-C',
          topic: 'По пропускам',
          degree: entry.absenceDegree,
        ),
        const SizedBox(height: 4),
        Text(
          entry.findings.join('\n'),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            degree == 0
                ? 'Болезнь $code: не выявлена - $topic'
                : 'Болезнь $code: ${_degrees[degree]} степени - $topic',
            style: AppText.body,
          ),
                        ...
                        builder: (_, v, _) => Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: LinearGradient(
                              colors: _stops.sublist(0, degree),
                            ),
                          ),
                        ),
                      ),
